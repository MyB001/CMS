...
usersRouter.post("/", (req, res) => {
  let body = req.body;
  let addNewUserQuery = `INSERT INTO Users VALUES (NULL, "${body.firsname}", "${body.lastname}", "${body.username}", "${body.password}", ${body.phone}, "${body.city}", "${body.email}", "${body.address}", ${body.score}, ${body.buy})`;
